...
def loginAdmin():
    ...
    def login():
        flag = 0
        loc = ('C:/Users/afeef hasan/Desktop/LOGINID.xlsx')
        wb = xlrd.open_workbook(loc)
        sheet = wb.sheet_by_index(0)
        for i in range(0,sheet.nrows):
                        ...
                        def addData():
                            ...
                            def write():
                                ...
                                if (z1 == "") or (z2 == "") or (z3 == "") or (z4 == "") or (z5 == "") or (z6 == "") or (z7 == ""):
                                    ...
                                    wb = op.load_workbook("C:/Users/afeef hasan/Desktop/CropsDataFile.xlsx")
                                    ws = wb.get_sheet_by_name("Sheet1")
                                    ws.append([z1,z2,int(z3),z4,z5,float(z6),float(z7)])
                                    wb.save(filename = 'C:/Users/afeef hasan/Desktop/CropsDataFile.xlsx')
                                    wb.close()
